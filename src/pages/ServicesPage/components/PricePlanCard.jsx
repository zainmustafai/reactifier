...
// const hoverClasses = "hover:shadow-xl hover:scale-105 transition-all duration-300";
const PricePlanCard = ({ plan }) => {
  return (
    <div className="  max-w-md mx-auto bg-white dark:bg-black shadow-lg rounded-lg p-6 hover:-translate-y-1 hover:shadow-xl hover:scale-[101%] transition-all duration-300 ">
